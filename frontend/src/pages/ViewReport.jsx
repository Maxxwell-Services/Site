...
import { Snowflake, AlertTriangle, CheckCircle, ShoppingCart, Home, LogIn, Calendar, User, Wrench, Info, Droplets, Thermometer, Wind, Zap, Filter, Flame, ArrowDownUp, Gauge, Camera, X, Triangle, Square, Plug2, Fan, Network, Container, Layers, Wind as AirFlow, Refrigerator, Search } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen px-2 sm:px-4 py-4 sm:py-8" style={{backgroundColor: '#f8f9fa'}}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Performance Metrics */}
        <div className="bg-white rounded-lg shadow-sm p-4 mb-4 border" style={{borderColor: '#e5e7eb'}}>
          <h3 className="text-base font-bold mb-3 pb-2 border-b" style={{color: '#1C325E', borderColor: '#e5e7eb'}}>SYSTEM PERFORMANCE METRICS</h3>
            ...
            {currentData.blower_motor_type === "PSC Motor" && currentData.blower_motor_capacitor_health && (
              ...
              >
                <h4 className="font-bold mb-3 text-lg flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Plug2 className="w-5 h-5 opacity-70" />
